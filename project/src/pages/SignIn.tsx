...
const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <div className="py-28 bg-gradient-to-br from-peach-50 to-peach-100 min-h-screen">
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl shadow-2xl border border-peach-200 overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-r from-peach-500 to-navy-700 px-8 py-8 text-center relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link to="/forgot-password" className="font-semibold text-peach-600 hover:text-peach-700 transition-colors">
                    Forgot password?
                  </Link>
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-peach-500 to-navy-600 text-white py-4 px-6 rounded-xl text-lg font-bold hover:from-peach-600 hover:to-navy-700 transition-all shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 transform hover:scale-105"
              >
                {isLoading ? (
                  <>
