    ...
    <div className="py-28 bg-gradient-to-br from-peach-50 to-peach-100 min-h-screen">
      <div className="max-w-lg mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl shadow-2xl border border-peach-200 overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-r from-navy-700 to-peach-500 px-8 py-8 text-center relative overflow-hidden">
          ...
          <div className="px-8 py-10">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <Phone className="absolute left-4 top-1/2 transform -translate-y-1/2 text-navy-400" size={20} />
                  <input
                    type="tel"
                    id="phone"
                    name="phone"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-navy-600 to-peach-500 text-white py-4 px-6 rounded-xl text-lg font-bold hover:from-navy-700 hover:to-peach-600 transition-all shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 transform hover:scale-105"
              >
                {isLoading ? (
                  <>
